/*
 ...
 "CI-V Router 2" is a device interacting with Wavelog and CI-V compatible devices.
 ...
 2025-06-22 DK4DJ	special handling for CIV7 deleted (now usable like all other ports); minor code clean up
 */ 
